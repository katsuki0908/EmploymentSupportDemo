...
export const EditContact = ({ student_id }: string) => {
  ...
  const handleSaveSubmit = async (
    ...
    if (
      ...
      formError.personal_address ||
      formError.emergency_address ||
      formError.emergency_phone
    ) {
      ...
      >
        ...
        <FormControl variant="standard">
          <TextField
            ...
            helperText={
              formError.personal_phone ? "半角数字のみ入力してください" : ""
            }
          />
          <TextField
            required
            ...
            helperText={
              formError.emergency_phone ? "半角数字のみ入力してください" : ""
            }
          />
          <TextField
            required
            ...
            helperText={
              formError.personal_address ? "住所を入力してください" : ""
            }
          />
          <TextField
            required
            ...
            helperText={
              formError.emergency_address ? "住所を入力してください" : ""
            }
          />
        </FormControl>
        <Collapse in={editing}>
