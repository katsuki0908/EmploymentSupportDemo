...
export default function OthersCareerContents() {
  ...
  const [selection_action, setSelection_action] = React.useState<
    action_table[]
  >([]);
  const [selection_career_name, setSelection_career_name] = React.useState<
    career_path_table[]
  >([]);
  ...
  return (
    <Box sx={{ width: "95%" }}>
      <Typography>その他を含むキャリア活動表示</Typography>
      <OthersCareerlist
