...
export default function JoblistAddFormDialog() {   
  ...
  const handleSubmit = async (event: React.MouseEvent<HTMLButtonElement>) => {//求人票追加処理
    event.preventDefault();

    console.log("formData = ", formData);
    console.log("application_format = ", application_format);
  ...
  const handleDateChange = (date: Date | null): void => {
    ...
    console.log("submissionDate = ", submission_date);
  };
      ...
      <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
        ...
        { <FormControl fullWidth margin="normal">
           <Autocomplete
            ...
            onChange={(event, value) => setFormData({ ...formData, career_path_id: value?.career_path_id || '' })} // 選択されたオブジェクトの 'name' プロパティを使用
          />
            </FormControl> }
